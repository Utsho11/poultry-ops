              ...
              <div className="glass-panel" style={{ padding: '20px', borderTop: '4px solid #D9A441' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', fontSize: '0.82rem' }}>
                    <div style={{ backgroundColor: '#F4EFE6', padding: '6px 10px', borderRadius: '6px' }}>🌾 Feed: ৳{batchDashboardData.expenseSection.costByCategory.feed.toLocaleString()}</div>
                    <div style={{ backgroundColor: '#F4EFE6', padding: '6px 10px', borderRadius: '6px' }}>💊 Meds: ৳{batchDashboardData.expenseSection.costByCategory.medicine.toLocaleString()}</div>
                    <div style={{ backgroundColor: '#F4EFE6', padding: '6px 10px', borderRadius: '6px' }}>👷 Labor: ৳{batchDashboardData.expenseSection.costByCategory.labor.toLocaleString()}</div>
                    <div style={{ backgroundColor: '#F4EFE6', padding: '6px 10px', borderRadius: '6px' }}>💡 Utility: ৳{batchDashboardData.expenseSection.costByCategory.utility.toLocaleString()}</div>
                  </div>
